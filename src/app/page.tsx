        ...
        <section className="hero">
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <p className="lede">
                Cloudvation delivers zero-downtime AWS migrations to keep your
                business running smoothly. From risk assessment and landing
                zones to phased migration and cost optimization, we handle the
                heavy lifting so your engineers can stay focused on building
                your core product.
              </p>
